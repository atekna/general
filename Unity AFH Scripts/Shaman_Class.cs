...
public struct Shaman_Class {
	...
	public Shaman_Class (string rname, int rhealth, int rmanna, int rstrength, int rdexterity, int rwisdom, int rconstitution){
	...
	private Shaman_Class(string rname){
		this.Name = rname;
	...
	public static Shaman_Class GetRandomChar(string name){
		return new Shaman_Class (name);
	}
